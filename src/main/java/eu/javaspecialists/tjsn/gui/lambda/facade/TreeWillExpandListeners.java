...
public interface TreeWillExpandListeners {
    static TreeWillExpandListener forTreeWillExpand(Consumer<TreeExpansionEvent> c) {
    ...
    static TreeWillExpandListener forTreeWillCollapse(Consumer<TreeExpansionEvent> c) {
        return new TreeExpansionAdapter() {
