...
public interface PopupMenuEventProducerMixin {
    default void addPopupMenuWillBecomeVisibleListener(Consumer<PopupMenuEvent> c) {
    ...
    default void addPopupMenuWillBecomeInvisibleListener(Consumer<PopupMenuEvent> c) {
        addPopupMenuListener(new PopupMenuAdapter() {
    ...
    default void addPopupMenuCanceledListener(Consumer<PopupMenuEvent> c) {
        addPopupMenuListener(new PopupMenuAdapter() {
