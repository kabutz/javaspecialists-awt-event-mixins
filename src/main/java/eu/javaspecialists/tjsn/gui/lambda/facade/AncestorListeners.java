...
public interface AncestorListeners {
    static AncestorListener forAncestorAdded(Consumer<AncestorEvent> c) {
    ...
    static AncestorListener forAncestorRemoved(Consumer<AncestorEvent> c) {
        return new AncestorAdapter() {
    ...
    static AncestorListener forAncestorMoved(Consumer<AncestorEvent> c) {
        return new AncestorAdapter() {
